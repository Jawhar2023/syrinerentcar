...
export const cars: Car[] = [
  ...
  },
  {
    ...
    acceleration: "10.5s",
    fuelType: "Essence",
    image: "/cars/dacia-sandero-stepway.png",
    rating: 4.6,
    reviews: 48,
    available: true,
    seats: 5,
  ...
  {
    id: "fiat-panda-4x4",
    name: "Panda City Cross",
    brand: "Fiat",
    type: "crossover",
    horsepower: 85,
    acceleration: "12.0s",
    fuelType: "Essence",
    image: "/cars/fiat-panda-4x4.png",
    rating: 4.5,
    reviews: 29,
    available: true,
    seats: 5,
    transmission: "Manuelle",
    description:
      "Fiat Panda City Cross — compacte crossover pratique et robuste, parfaite pour la ville comme pour les chemins secondaires.",
  },
  {
    id: "mahindra-xuv300",
    name: "XUV300",
    ...
    acceleration: "9.5s",
    fuelType: "Diesel",
    image: "/cars/mahindra-xuv300.png",
    rating: 4.7,
    reviews: 44,
    available: true,
    seats: 5,
